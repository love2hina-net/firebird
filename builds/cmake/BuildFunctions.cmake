...
if (WIN32)
    function(set_exported_symbols target filename)
        ...
        if (NOT "${def_file}" STREQUAL "")
            if (MSVC)
                set_target_properties(${target} PROPERTIES LINK_FLAGS "/DEF:\"${FIREBIRD_SOURCE_DIR}/builds/win32/defs/${def_file}\"")
            endif()
            if (MINGW)
                #set_target_properties(${target} PROPERTIES LINK_FLAGS "-Wl,${FIREBIRD_SOURCE_DIR}/builds/win32/defs/${def_file}")
            endif()
        endif()
